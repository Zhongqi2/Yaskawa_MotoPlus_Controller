...
//	MP_RAD_POS_RSP_DATA rFB_joint_data;
//	STATUS status;
//	BOOL bInitOk;
//	PULSE_TO_RAD PulseToRad;
//	MP_PULSE_POS_RSP_DATA pulse_data;
//	float joint_pos[MP_GRP_AXES_NUM] = { 0 };
//	err_counter = 0;
...
//		printf("PulseToRad value:");
//		for (i = 0; i < MP_GRP_AXES_NUM; i++)
//		{
//			printf("%f", PulseToRad.PtoR[i]);
//
...
//
//
//			joint_pos[i] = pulse_data.lPos[i] / PulseToRad.PtoR[i];
...
//		if (status != OK)
//			bInitOk = FALSE;
//		mpGetRadPos(&sData, &rFB_joint_data);
//		printf("\n--rFB_joint_data--\n");
//		for (i = 0; i < MP_GRP_AXES_NUM; i++)
//		{
//			printf("%ld", rFB_joint_data.lRadPos[i]);
//
//			if (i != (MP_GRP_AXES_NUM - 1))
//			{
//				printf(", ");
